...
IS_TOUCH, SCREEN_SHOW_ALL = !0; (function(a, d) {
	...
	a.showMoreGames = function(b) {
		if (null == e) {
			e = new createjs.Text("【更多游戏】", "40px Arial", "#1c85e7");
			e.textAlign = "right";
...
function MyProgressBar(a, d, b) {
	...
	b.textAlign = "center";
	this.addChild(b);
	b = new createjs.Text("微信公众号: mkongzhong", "38px Arial", "black");
	b.x = a / 2;
	b.y = 260;
	b.textAlign = "center";
	this.addChild(b);
	b = new createjs.Text("(c)2016 空中传媒\game.ikongzhong.cn", "32px Arial", "black");
	b.x = a / 2;
	b.y = d - 100;
	b.textAlign = "center";
	this.addChild(b)
